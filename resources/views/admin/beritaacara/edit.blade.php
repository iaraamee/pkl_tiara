...
<div class="row column_title">   
    <div class="col-md-12">   
       <div class="page_title">   
          <h2>Edit Data Berita Acara</h2>   
       </div>   
    </div>   
  </div>   
  <div class="white_shd full margin_bottom_30">   
    <div class="padding_infor_info">   
        <form method="post" action="/admin/data/beritaacara/edit/{{$data->id}}">   
            @csrf   
        <fieldset>   
            <div class="field">   
               <label class="label_field">Nomor Surat</label>   
               <input type="text" class="form-control" name="no_beritaacara" value="{{$data->no_beritaacara}}">   
            </div> 
            ...
            <div class="field">   
                ...
                <input type="text" class="form-control" name="alamat_tujuan" value="{{$data->alamat_tujuan}}">   
             </div>    
